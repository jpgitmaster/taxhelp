          ...
          <Slider {...fadeSettings} ref={sliderRef}>
            <div className={scss.banner}>
              ...
              <div className={scss.bannerRight}>
                <img src="https://images.unsplash.com/photo-1642043175009-5997b3a078d8?q=80&w=1035&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Accounting Team" />
              </div>
            </div>
            <div className={scss.banner}>
              <div className={scss.bannerLeft}>
